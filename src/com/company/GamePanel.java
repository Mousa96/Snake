...
public class GamePanel extends JPanel implements ActionListener {
    ...
    // the coordinates of the snake bodyParts
    final int x[] = new int[GAME_UNITS];
    final int y[] = new int[GAME_UNITS];
    int bodyParts = 6;
    int applesEaten;
    // the coordinates of the apple which will be random each time
    int appleX;
    int appleY;
    // the direction which the snake will move to, default will be right
    char direction = 'R';
    ...
    // gets called automatically by this.setResizable in GameFrame
    @Override
    ...
    public void draw(Graphics g) {
        ...
        if (running) {
            /*drawing a grid for testing purposes
